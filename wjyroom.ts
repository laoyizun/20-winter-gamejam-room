...
namespace wjyroom {
  ...
  let 幽灵: Sprite = null
  let wsboss = 0
  let bo_s_s: Sprite = null
  let wboossssssss = 0
  let z_d: Sprite = null
  let projectile: Sprite = null
  let 吴b = 0
  let 吴_giao子: Sprite = null
  ...
  export function init() {
    ...
    scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.collectibleInsignia, function (sprite, location) {
      ...
      if (boss == 1) {
        ...
        hp.attachToSprite(bo_s_s)
        hp.setBarBorder(10, 2)
        bo_s_s.setVelocity(50, 50)
        bo_s_s.setFlag(SpriteFlag.BounceOnWall, true)
        tiles.placeOnTile(bo_s_s, tiles.getTileLocation(5, 11))
      }
    })
